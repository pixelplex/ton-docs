...
| AWS              | `i4i.4xlarge`         | `16 vCPUs`     | `128GB`| `1 x 3,750 AWS Nitro SSD (fixed)` | `Up to 25 Gbps` | Bind an Elastic IP | `16 TB/month`|
...
### Testnet 
Flag `-c` should be provided with `https://ton.org/testnet-global.config.json` value while [installing](/participate/run-nodes/full-node#install-the-mytonctrl).
